...
if [[ ${PV} == *9999 ]]; then
	...
	# CROS_WORKON_COMMIT="be70508bb5af96e97cbfc88f73a04c55af2595cc"  # csphere 1.0.1
...
# remove linux-info to turn off fucking kernel require
inherit bash-completion-r1 multilib systemd udev user cros-workon
...
src_compile() {
	...
	git log --pretty=format:"%h - %an, %ai : %s" -1 | sudo tee /tmp/csphere-product-version/csphere-product-docker.txt
